...
function hs() {
  if (Yn) {
    var e = Yn,
      n = Gn;
    if (((Gn = Yn = null), Wu(e), n)) for (e = 0; e < n.length; e++) Wu(n[e]);
  }
}
function ys(e, n) {
  return e(n);
...
function bo(e, n, t, r) {
  if (Dr) {
    var l = co(e, n, t, r);
    if (l === null) Il(e, n, r, jr, t), Yu(e, r);
...
function Vs(e) {
  if (e.propertyName === "value" && rl(Ft)) {
    var n = [];
    Us(n, Ft, e, Xo(e)), ws(Rf, n);
  }
}
function Mf(e, n, t) {
  e === "focusin"
    ? (ri(), (xt = n), (Ft = t), xt.attachEvent("onpropertychange", Vs))
    : e === "focusout" && ri();
}
function If(e) {
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[je], delete n[At], delete n[go], delete n[Gf], delete n[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, W()), !(R & 6) && ((lt = W() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = xu;
gs = Tn;
var zd = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, vs, hs, xu] },
  yt = {
...
const Rd = ({ addNewCategory: e }) => {
    const [n, t] = tn.useState(""),
      r = ({ target: o }) => {
        t(o.value);
      },
      l = (o) => {
        o.preventDefault(), !(n.trim().length <= 1) && e(n.trim());
      };
    return q.jsx("form", {
      onSubmit: l,
      children: q.jsx("input", {
        type: "text",
        placeholder: "introdusca nuevo",
        value: n,
        onChange: r,
      }),
    });
  },
  Od = ({ title: e, url: n, id: t }) =>
    q.jsxs("div", {
      className: "card",
      children: [q.jsx("img", { src: n, alt: e }), q.jsx("p", { children: e })],
    }),
  Md = async (e) => {
    const n = `https://api.giphy.com/v1/gifs/search?api_key=N3kfSLq328L8g0stgN24rdjJklCIIUbo&q=${e}&limit=10`,
      t = await fetch(n),
      { data: r } = await t.json();
    return r.map((o) => ({
      id: o.id,
      title: o.title,
      url: o.images.downsized_medium.url,
    }));
  },
  Id = (e) => {
    const [n, t] = tn.useState([]),
    ...
    return (
      ...
      { images: n, isLoading: r }
    );
  },
  Dd = ({ category: e }) => {
    const { images: n, isLoading: t } = Id(e);
    return (
      console.log({ images: n, isLoading: t }),
      q.jsxs(q.Fragment, {
        children: [
          q.jsx("h3", { children: e }),
          ...
          q.jsx("div", {
            className: "card-grid",
            children: n.map((r) => q.jsx(Od, { ...r }, r.id)),
          }),
        ],
      })
    );
  ...
  jd = () => {
    const [e, n] = tn.useState(["dragon ball"]),
      t = (r) => {
        n([r, ...e]);
      };
    return q.jsxs("div", {
      children: [
        q.jsx(Rd, { addNewCategory: t }),
        e.map((r) =>
          q.jsx("ol", { children: q.jsx(Dd, { category: r }, r) }, r)
        ),
      ],
    });
  };
Ql.createRoot(document.getElementById("root")).render(
  q.jsx(gc.StrictMode, { children: q.jsx(jd, {}) })
);
